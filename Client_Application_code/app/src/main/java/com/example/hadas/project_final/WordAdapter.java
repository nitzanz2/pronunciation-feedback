...
/**
 * WordAdapter - connect between the words list and the listView
 */
public class WordAdapter extends BaseAdapter  {
    ...
    Word item;
    /**
     * WordAdapter constructor - initialize the adapter
     * input - the activity that diplay the list.
     * a list of words
     */
    public WordAdapter(Activity activity, List<Word> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        fvr = (ImageView) convertView.findViewById(R.id.favorite);
        if(item.getFvr())
            fvr.setImageResource(R.drawable.on);
        else
            fvr.setImageResource(R.drawable.off);
