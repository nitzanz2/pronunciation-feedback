...
/**
 * HistoryAdapter - connect between the scores list and the listView
 */
public class HistoryAdapter extends BaseAdapter  {
    ...
    /**
     * HistoryAdapter constructor - initialize the adapter
     * input - the activity that diplay the list.
     * a list of words
     */
    public HistoryAdapter(Activity activity, List<Word> items) {
