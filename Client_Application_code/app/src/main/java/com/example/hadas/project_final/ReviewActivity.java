...
/**
 * ReviewActivity - list of words that had been recorded
 */
public class ReviewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reviewAdapter = new ReviewAdapter(ReviewActivity.this, copy);
        lst.setAdapter(reviewAdapter);
    ...
    private void addListener() {
        ...
        for (Word w:words) {
            View.OnClickListener listener=new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ReviewActivity.this, ScoresActivity.class);
